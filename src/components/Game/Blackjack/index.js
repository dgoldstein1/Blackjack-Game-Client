...
class Blackjack extends Component {
  ...
  render() {
    ...
    const other = this.props.playersInGame.find(player => player.id !== this.props.userLogedIn.id)
    ...
    return (
      ...
      {deck && draws.length >= 0 && <span>
        <b>Card amount</b>: {score} </span>}
      </div>
      ...
      {deck && this.props.userLogedIn.id === this.props.currentTurn.id && (<div>
      ...
      {other && (<div>
        ...
        <p><b>Card amount</b>: {other.score}</p>
